...
#####
if (!dir.exists("3_data_analysis/6-network_analysis/GSEA/ba52_ctrl/ba52_ctrl_reactome")) {
  dir.create(
    "3_data_analysis/6-network_analysis/GSEA/ba52_ctrl/ba52_ctrl_reactome",
    recursive = TRUE,
    showWarnings = FALSE
  )
}
...
setwd("3_data_analysis/6-network_analysis/GSEA/ba52_ctrl/ba52_ctrl_reactome")
...
gene_nodes <- tibble(
  ...
  left_join(
    tibble(
      ...
      size = abs(log2(data_all$fc_ba52_ctrl)),
...
ggsave(
  plot,
  filename = "top10_NES_pathway_network_ba52_ctrl_reactome.pdf",
  width = 8.5,
  height = 7,
  bg = "transparent",
  dpi = 300
...
ggsave(
  plot,
  filename = "top10_NES_pathway_network_ba52_ctrl_reactome.png",
  width = 8.5,
  height = 7,
  bg = "transparent",
  dpi = 300
