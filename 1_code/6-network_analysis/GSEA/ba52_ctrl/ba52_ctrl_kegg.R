...
#####
if (!dir.exists("3_data_analysis/6-network_analysis/GSEA/ba52_ctrl/ba52_ctrl_kegg")) {
  dir.create(
    "3_data_analysis/6-network_analysis/GSEA/ba52_ctrl/ba52_ctrl_kegg",
    recursive = TRUE,
    showWarnings = FALSE
  )
}
...
setwd("3_data_analysis/6-network_analysis/GSEA/ba52_ctrl/ba52_ctrl_kegg")
...
ggsave(
  plot,
  filename = "top10_NES_pathway_network_ba52_ctrl_kegg.pdf",
  width = 8.5,
  height = 7,
  bg = "transparent",
  dpi = 300
...
ggsave(
  plot,
  filename = "top10_NES_pathway_network_ba52_ctrl_kegg.png",
  width = 8.5,
  height = 7,
  bg = "transparent",
  dpi = 300
