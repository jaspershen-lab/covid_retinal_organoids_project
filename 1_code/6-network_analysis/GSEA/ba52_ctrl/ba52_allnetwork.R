...
filtered_edges <- edge_data %>%
  ...
  group_modify(~{
    if(first(.x$pathway_nes) > 0) {
      arrange(.x, desc(fc_ba52_ctrl))  # NES正，选择fold change最大的基因
    } else {
      arrange(.x, fc_ba52_ctrl)        # NES负，选择fold change最小的基因
    }
  }) %>%
  slice_head(n = 3) %>%
  ungroup()
...
ggsave(
  plot,
  filename = "top10_NES_pathway_network_ba52_ctrl_all_top10.pdf",
  width = 10,
  height = 5,
  bg = "transparent",
  dpi = 300
...
ggsave(
  plot,
  filename = "top10_NES_pathway_network_ba52_ctrl_all_top10.png",
  width = 10,
  height = 5,
  bg = "transparent",
  dpi = 300
...
ggsave(
  barplot,
  filename = "top10_NES_pathway_network_ba52_ctrl_all_top10_barplot.pdf",
  width = 8.5,
  height = 7,
  bg = "transparent",
  dpi = 300
...
ggsave(
  barplot,
  filename = "top10_NES_pathway_network_ba52_ctrl_all_top10_barplot.png",
  width = 8.5,
  height = 7,
  bg = "transparent",
  dpi = 300
