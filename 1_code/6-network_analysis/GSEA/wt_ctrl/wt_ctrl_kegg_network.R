...
output_dir <- "3_data_analysis/6-network_analysis/GSEA/wt_ctrl/wt_ctrl_kegg"
...
ggsave(
  plot,
  filename = "top10_NES_pathway_network_wt_ctrl_kegg.pdf",
  width = 8.5,
  height = 7,
  bg = "transparent",
  dpi = 300
...
ggsave(
  plot,
  filename = "top10_NES_pathway_network_wt_ctrl_kegg.png",
  width = 8.5,
  height = 7,
  bg = "transparent",
  dpi = 300
