...
#####
if (!dir.exists("3_data_analysis/6-network_analysis/GSEA/bq11_ctrl/bq11_ctrl_go")) {
  dir.create(
    "3_data_analysis/6-network_analysis/GSEA/bq11_ctrl/bq11_ctrl_go",
    recursive = TRUE,
    showWarnings = FALSE
  )
}
...
setwd("3_data_analysis/6-network_analysis/GSEA/bq11_ctrl/bq11_ctrl_go")
...
ggsave(
  plot,
  filename = "top10_NES_pathway_network_bq11_ctrl_go.pdf",
  width = 8.5,
  height = 7,
  bg = "transparent",
  dpi = 300
...
ggsave(
  plot,
  filename = "top10_NES_pathway_network_bq11_ctrl_go.png",
  width = 8.5,
  height = 7,
  bg = "transparent",
  dpi = 300
