...
load("3_data_analysis/1-data-preparation/1-transcriptome/transcriptome_data.RData")

dir.create("3_data_analysis/2-data-cleaning/1-transcriptome",
           showWarnings = FALSE)

setwd("3_data_analysis/2-data-cleaning/1-transcriptome/")
