...
load("3_data_analysis/1-data-preparation/2-metabolome/metabolome_data.RData")

dir.create("3_data_analysis/2-data-cleaning/2-metabolome",
           showWarnings = FALSE)

setwd("3_data_analysis/2-data-cleaning/2-metabolome/")
