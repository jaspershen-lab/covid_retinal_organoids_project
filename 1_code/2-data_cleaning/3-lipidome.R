...
load("3_data_analysis/1-data-preparation/3-lipidome/lipidome_data.RData")

dir.create("3_data_analysis/2-data-cleaning/3-lipidome", showWarnings = FALSE)

setwd("3_data_analysis/2-data-cleaning/3-lipidome/")
