...
total_genes <- nrow(transcriptome_data@variable_info)
total_genes


sig_genes <- transcriptome_data@variable_info %>%
...
# extract genelist
#wt_ctrl
sig_genes_wt_ctrl <- transcriptome_data@variable_info %>%
  filter(p_value_adjust_wt_ctrl < 0.05)
...
#ba52_ctrl
sig_genes_ba52_ctrl <- transcriptome_data@variable_info %>%
  filter(p_value_adjust_ba52_ctrl < 0.05)
...
#bq11_ctrl
sig_genes_bq11_ctrl <- transcriptome_data@variable_info %>%
  filter(p_value_adjust_bq11_ctrl < 0.05)
